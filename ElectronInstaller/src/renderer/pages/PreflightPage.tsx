...
interface PreflightPageProps {
  ...
  onTrustWindowsRootCertificate: () => Promise<void>;
          ...
          {report.checks.map((check) => {
            ...
            return (
              ...
              >
                ...
                {check.repairable &&
                check.repairAction === "trust-certificate" ? (
                  <Button
                    size="small"
                    variant="contained"
                    color="warning"
                    sx={{ mt: 1 }}
                    disabled={busy}
                    onClick={() => void onTrustWindowsRootCertificate()}
                  >
                    Añadir certificado en Windows a certificados de confianza
                  </Button>
                ) : null}
                {check.repairable &&
