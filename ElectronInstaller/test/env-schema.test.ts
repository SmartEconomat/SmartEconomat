...
describe("env.schema.json", () => {
  it("valida un payload de entorno de producción mínimo esperado", async () => {
    ...
    const sample = {
      ...
      JWT_EXPIRATION: "7d",
      SEED_DEFAULT_ADMIN_TEMP_PASSWORD: "AdminTemporal2026",
      SEED_DEFAULT_ADMIN_USER_TEMP_PASSWORD: "AdminTemporal2026",
      SEED_DEFAULT_ADMIN_USERNAME: "admin",
      SEED_DEFAULT_SUPERADMIN_USERNAME: "superadmin",
      SEED_DEFAULT_SUPERADMIN_TEMP_PASSWORD: "SuperAdminTemporal2026",
