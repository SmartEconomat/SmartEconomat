...
_ts_decorate([
    (0, _typeorm.ManyToMany)(()=>_permisoentity.Permiso, (permiso)=>permiso.roles, {
        cascade: false
    }),
...
_ts_decorate([
    (0, _typeorm.ManyToMany)(()=>_usuarioentity.Usuario, (usuario)=>usuario.roles),
    _ts_metadata("design:type", Array)
...
Rol = _ts_decorate([
    ...
    (0, _typeorm.Index)('idx_rol_nombre', [
        'nombre'
    ]),
    (0, _typeorm.Index)('idx_rol_activo', [
        'activo'
    ])
], Rol);
