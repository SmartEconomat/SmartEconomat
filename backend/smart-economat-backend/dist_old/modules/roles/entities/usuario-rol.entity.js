...
UsuarioRol = _ts_decorate(
  [
    ...
    (0, _typeorm.Index)('idx_usuario_rol_usuario', ['usuarioId']),
    (0, _typeorm.Index)('idx_usuario_rol_rol', ['rolId']),
    (0, _typeorm.Index)('idx_usuario_rol_activo', ['activo']),
  ],
  UsuarioRol
);
