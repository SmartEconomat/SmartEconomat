...
], RolPermiso.prototype, "asignadoEn", void 0);
_ts_decorate([
    (0, _typeorm.Column)({
        type: 'uuid',
        nullable: true,
    ...
    _ts_metadata("design:type", String)
], RolPermiso.prototype, "asignadoPor", void 0);
_ts_decorate([
...
RolPermiso = _ts_decorate([
    ...
    (0, _typeorm.Index)('idx_rol_permiso_rol', [
        'rolId'
    ]),
    (0, _typeorm.Index)('idx_rol_permiso_permiso', [
        'permisoId'
    ])
], RolPermiso);
