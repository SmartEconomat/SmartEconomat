...
let AlbaranPedidoRecepcion = class AlbaranPedidoRecepcion
...
_ts_decorate(
  ...
  AlbaranPedidoRecepcion.prototype,
  'albaranId',
  void 0
);
_ts_decorate(
...
_ts_decorate(
  [
    (0, _typeorm.ManyToOne)(
      ...
      (albaran) => albaran.albaranPedidoRecepcion,
      {
        onDelete: 'CASCADE',
      }
    ),
...
AlbaranPedidoRecepcion = _ts_decorate(
  [
    ...
    (0, _typeorm.Index)(['albaranId']),
    (0, _typeorm.Index)(['recepcionPedidoId']),
  ],
