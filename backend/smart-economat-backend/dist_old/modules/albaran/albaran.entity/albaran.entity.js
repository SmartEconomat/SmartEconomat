...
], Albaran.prototype, "nAlbaran", void 0);
_ts_decorate([
    (0, _typeorm.Column)({
        type: 'boolean',
        nullable: true
...
], Albaran.prototype, "concordancia", void 0);
_ts_decorate([
    (0, _typeorm.Column)({
        type: 'timestamptz',
        nullable: true
...
], Albaran.prototype, "fecha", void 0);
_ts_decorate([
    (0, _typeorm.OneToMany)(()=>_albaranpedidorecepcionentity.AlbaranPedidoRecepcion, (apr)=>apr.albaran),
    _ts_metadata("design:type", typeof Relation === "undefined" ? Object : Relation)
], Albaran.prototype, "albaranPedidoRecepcion", void 0);
Albaran = _ts_decorate([
    (0, _typeorm.Entity)({
        name: 'albaran'
    }),
    (0, _typeorm.Index)('idx_albaran_n_albaran', [
        'nAlbaran'
    ]),
    (0, _typeorm.Index)('idx_albaran_fecha', [
        'fecha'
    ])
], Albaran);
