...
_ts_decorate([
    (0, _classvalidator.IsInt)({
        message: (0, _nestjsi18n.i18nValidationMessage)('validation.LA_CANTIDAD_DEBE_SER_UN_N_MERO_ENTERO')
    }),
    (0, _classvalidator.Min)(0, {
        message: (0, _nestjsi18n.i18nValidationMessage)('validation.LA_CANTIDAD_NO_PUEDE_SER_NEGATIVA')
    }),
...
_ts_decorate([
    ...
    (0, _classvalidator.IsString)({
        message: (0, _nestjsi18n.i18nValidationMessage)('validation.EL_TIPO_DE_ENTIDAD_DEBE_SER_UNA_CADENA_D')
    }),
    _ts_metadata("design:type", String)
], CreateMovimientoDto.prototype, "entidadTipo", void 0);
_ts_decorate([
    (0, _classtransformer.Transform)(_trimstringtransformer.TrimStringTransformer.transform),
    (0, _classvalidator.IsString)({
        message: (0, _nestjsi18n.i18nValidationMessage)('validation.EL_ID_DE_ENTIDAD_DEBE_SER_UNA_CADENA_DE')
    }),
    _ts_metadata("design:type", String)
], CreateMovimientoDto.prototype, "entidadId", void 0);
_ts_decorate([
    ...
    _ts_metadata("design:type", String)
], CreateMovimientoDto.prototype, "descripcion", void 0);
_ts_decorate([
    (0, _classvalidator.IsUUID)('7', {
        message: (0, _nestjsi18n.i18nValidationMessage)('validation.EL_ID_DEL_INVENTARIO_DEBE_SER_UN_UUID_V')
    }),
    (0, _classvalidator.IsOptional)(),
    _ts_metadata("design:type", String)
], CreateMovimientoDto.prototype, "inventario", void 0);
_ts_decorate([
    (0, _classvalidator.IsUUID)('7', {
    ...
    (0, _classvalidator.IsOptional)(),
    _ts_metadata("design:type", String)
], CreateMovimientoDto.prototype, "usuario", void 0);
