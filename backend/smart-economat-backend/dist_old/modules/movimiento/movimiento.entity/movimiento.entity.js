...
], Movimiento.prototype, "usuarioId", void 0);
_ts_decorate([
    (0, _typeorm.Column)({
        name: 'inventario_id',
        nullable: true
    ...
    _ts_metadata("design:type", String)
], Movimiento.prototype, "inventarioId", void 0);
_ts_decorate([
    (0, _typeorm.Column)({
    ...
    _ts_metadata("design:type", String)
], Movimiento.prototype, "productoProveedorId", void 0);
_ts_decorate([
    (0, _typeorm.Column)({
        type: 'enum',
...
_ts_decorate([
    (0, _typeorm.ManyToOne)(()=>_usuarioentity.Usuario, (usuario)=>usuario.movimientos, {
        nullable: true,
        onDelete: 'SET NULL'
    }),
...
_ts_decorate([
    ...
    _ts_metadata("design:type", typeof Relation === "undefined" ? Object : Relation)
], Movimiento.prototype, "inventario", void 0);
_ts_decorate([
    ...
    _ts_metadata("design:type", typeof Relation === "undefined" ? Object : Relation)
], Movimiento.prototype, "productoProveedor", void 0);
_ts_decorate([
    (0, _typeorm.Column)({
        type: 'varchar',
        length: 50,
    ...
    _ts_metadata("design:type", String)
], Movimiento.prototype, "entidad", void 0);
_ts_decorate([
    (0, _typeorm.Column)({
        type: 'uuid',
        name: 'entidad_id'
    ...
    _ts_metadata("design:type", String)
], Movimiento.prototype, "entidadId", void 0);
_ts_decorate([
    (0, _typeorm.Column)({
        type: 'text',
        nullable: true
