...
_ts_decorate([
    ...
    (0, _classvalidator.MaxLength)(150, {
        message: (0, _nestjsi18n.i18nValidationMessage)('validation.EL_NOMBRE_NO_PUEDE_SUPERAR_LOS_150_CARAC')
    }),
...
_ts_decorate([
    ...
    (0, _classvalidator.MaxLength)(255, {
        message: (0, _nestjsi18n.i18nValidationMessage)('validation.LA_DESCRIPCI_N_NO_PUEDE_SUPERAR_LOS_255')
    }),
    _ts_metadata("design:type", String)
