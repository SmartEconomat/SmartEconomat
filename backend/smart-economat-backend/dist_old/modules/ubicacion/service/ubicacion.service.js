...
let UbicacionService = class UbicacionService {
    async create(createUbicacionDto) {
        ...
        if (existing) {
            throw new _common.BadRequestException(_i18nhelper.I18nHelper.getError('YA_EXISTE_UNA_UBICACI_N_CON_ESTE_NOMBRE'));
        }
    ...
    async findOne(id) {
        ...
        if (!ubicacion) {
            throw new _common.NotFoundException(_i18nhelper.I18nHelper.getError('UBICACI_N_NO_ENCONTRADA'));
        }
        return ubicacion;
    }
