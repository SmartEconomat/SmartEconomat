        ...
        imports: [
            ...
            _platformexpress.MulterModule.registerAsync({
                ...
                useFactory: (configService)=>{
                    const uploadDir = configService.get('LOCAL_STORAGE_PATH', './uploads');
                    ...
                    return {
                        ...
                        limits: {
                            fileSize: configService.get('MAX_FILE_SIZE_MB', 10) * 1024 * 1024
                        },
                        fileFilter: (req, file, cb)=>{
                            if (file.mimetype.match(/\/(jpg|jpeg|png|gif|pdf)$/)) {
                                cb(null, true);
                            } else {
                                cb(new _common.BadRequestException(_i18nhelper.I18nHelper.getError('TIPO_DE_ARCHIVO_NO_SOPORTADO')), false);
                            }
                        }
                    };
                }
