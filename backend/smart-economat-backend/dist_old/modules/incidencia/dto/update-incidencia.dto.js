...
let UpdateIncidenciaDto = class UpdateIncidenciaDto extends (0, _mappedtypes.PartialType)(_createincidenciadto.CreateIncidenciaDto) {
};
_ts_decorate([
    (0, _classtransformer.Transform)(_trimstringtransformer.TrimStringTransformer.transform),
    _ts_metadata("design:type", String)
], UpdateIncidenciaDto.prototype, "observacionesRecepcion", void 0);
let UpdateIncidenciaResuelaDto = class UpdateIncidenciaResuelaDto extends (0, _mappedtypes.PartialType)(_createincidenciadto.CreateIncidenciaResuelaDto) {
};
_ts_decorate([
    (0, _classtransformer.Transform)(_trimstringtransformer.TrimStringTransformer.transform),
    _ts_metadata("design:type", String)
], UpdateIncidenciaResuelaDto.prototype, "observaciones", void 0);
