...
], Incidencia.prototype, "recepcionId", void 0);
_ts_decorate([
    (0, _typeorm.Column)({
        name: 'pedido_id',
        nullable: true
    ...
    _ts_metadata("design:type", String)
], Incidencia.prototype, "pedidoId", void 0);
_ts_decorate([
    (0, _typeorm.Column)({
    ...
    _ts_metadata("design:type", String)
], Incidencia.prototype, "usuarioResolutorId", void 0);
_ts_decorate([
...
], Incidencia.prototype, "recepcion", void 0);
_ts_decorate([
    ...
    _ts_metadata("design:type", typeof Relation === "undefined" ? Object : Relation)
], Incidencia.prototype, "pedido", void 0);
_ts_decorate([
    (0, _typeorm.ManyToOne)(()=>_usuarioentity.Usuario, (usuario)=>usuario.incidenciasResueltas, {
        onDelete: 'SET NULL',
        nullable: true
    }),
    (0, _typeorm.JoinColumn)({
    ...
    _ts_metadata("design:type", typeof Relation === "undefined" ? Object : Relation)
], Incidencia.prototype, "usuarioResolutor", void 0);
_ts_decorate([
    (0, _typeorm.OneToMany)(()=>_incidencialineaentity.IncidenciaLinea, (linea)=>linea.incidencia, {
        cascade: true
    }),
    _ts_metadata("design:type", typeof Relation === "undefined" ? Object : Relation)
], Incidencia.prototype, "lineas", void 0);
_ts_decorate([
    (0, _typeorm.Column)({
        type: 'text',
        nullable: true,
    ...
    _ts_metadata("design:type", String)
], Incidencia.prototype, "observacionesRecepcion", void 0);
_ts_decorate([
    (0, _typeorm.Column)({
        type: 'text',
        nullable: true,
    ...
    _ts_metadata("design:type", String)
], Incidencia.prototype, "observacionesResolucion", void 0);
_ts_decorate([
    (0, _typeorm.Column)({
        type: 'timestamptz',
        nullable: true,
...
], Incidencia.prototype, "fechaResolucion", void 0);
