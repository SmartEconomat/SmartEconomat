...
let IncidenciaResuelaService = class IncidenciaResuelaService {
    async create(dto) {
        ...
        const resolucionExistente = await this.incidenciaResuelaRepository.findByIncidencia(dto.idIncidencia);
    ...
    async findOne(id) {
        ...
        if (!resolucion) {
            throw new _common.NotFoundException(_i18nhelper.I18nHelper.getError('INCIDENCIA_RESUELTA_NOT_FOUND'));
        }
        return resolucion;
    }
    async update(id, dto) {
...
//# sourceMappingURL=incidencia-resuelta.service.js.map