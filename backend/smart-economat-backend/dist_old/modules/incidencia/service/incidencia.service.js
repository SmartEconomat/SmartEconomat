...
let IncidenciaService = class IncidenciaService {
    ...
    async findOne(id) {
        ...
        if (!incidencia) {
            throw new _common.NotFoundException(_i18nhelper.I18nHelper.getError('INCIDENCIA_NOT_FOUND'));
        }
        return incidencia;
    }
    async update(id, dto) {
        ...
        if (incidencia.estaResuelta()) {
            throw new _common.BadRequestException(_i18nhelper.I18nHelper.getError('INCIDENCIA_YA_RESUELTA'));
        }
    ...
    async reportarIncidencia(dto) {
        ...
        if (!recepcion) {
            throw new _common.NotFoundException(_i18nhelper.I18nHelper.getError('RECEPTION_NOT_FOUND'));
        }
    ...
    async resolverIncidenciaTransaccional(id, dto, usuarioId) {
        ...
        return await this.dataSource.transaction(async (manager)=>{
            ...
            const resolucion = manager.create(_incidenciaresueltaentity.IncidenciaResuelta, {
            ...
            if (dto.accion === _incidenciaenums.TipoResolucion.DEVOLUCION) {
                ...
                await this.movimientoHelper.createMovimiento(usuarioId, _movimientoenums.TipoMovimiento.SALIDA_AJUSTE, 'Incidencia', incidencia.id, 0, undefined, undefined, `Ajuste por resolución de incidencia (${dto.accion}): ${dto.observaciones || ''}`);
            }
    ...
    constructor(incidenciaRepository, incidenciaResueltaRepository, recepcionRepository, dataSource, movimientoHelper){
...
IncidenciaService = _ts_decorate([
    ...
    _ts_metadata("design:paramtypes", [
        typeof _incidenciarepository.IncidenciaRepository === "undefined" ? Object : _incidenciarepository.IncidenciaRepository,
        typeof _incidenciaresueltarepository.IncidenciaResuelaRepository === "undefined" ? Object : _incidenciaresueltarepository.IncidenciaResuelaRepository,
...
//# sourceMappingURL=incidencia.service.js.map