...
_ts_decorate([
    ...
    _ts_metadata("design:paramtypes", [
        typeof _createrecepcionproductodto.CreateRecepcionProductoDto === "undefined" ? Object : _createrecepcionproductodto.CreateRecepcionProductoDto
    ]),
    _ts_metadata("design:returntype", typeof Promise === "undefined" ? Object : Promise)
], RecepcionProductoController.prototype, "create", null);
_ts_decorate([
    (0, _common.Get)(),
    ...
    _ts_metadata("design:returntype", typeof Promise === "undefined" ? Object : Promise)
], RecepcionProductoController.prototype, "findAll", null);
_ts_decorate([
    (0, _common.Get)(':id'),
    ...
    _ts_metadata("design:returntype", typeof Promise === "undefined" ? Object : Promise)
], RecepcionProductoController.prototype, "findOne", null);
_ts_decorate([
    (0, _common.Patch)(':id'),
    (0, _requirepermissionsdecorator.RequirePermissions)('recepciones:editar'),
    _ts_param(0, (0, _common.Param)('id', _pipes.ParseUUIDv7Pipe)),
    ...
    _ts_metadata("design:paramtypes", [
        String,
        typeof _updaterecepcionproductodto.UpdateRecepcionProductoDto === "undefined" ? Object : _updaterecepcionproductodto.UpdateRecepcionProductoDto
    ]),
    _ts_metadata("design:returntype", typeof Promise === "undefined" ? Object : Promise)
], RecepcionProductoController.prototype, "update", null);
_ts_decorate([
    (0, _common.Delete)(':id'),
    (0, _requirepermissionsdecorator.RequirePermissions)('recepciones:eliminar'),
    ...
    _ts_metadata("design:returntype", typeof Promise === "undefined" ? Object : Promise)
], RecepcionProductoController.prototype, "remove", null);
RecepcionProductoController = _ts_decorate([
    ...
    _ts_metadata("design:type", Function),
    _ts_metadata("design:paramtypes", [
        typeof _recepcionproductoservice.RecepcionProductoService === "undefined" ? Object : _recepcionproductoservice.RecepcionProductoService
    ])
], RecepcionProductoController);

//# sourceMappingURL=recepcion-producto.controller.js.map