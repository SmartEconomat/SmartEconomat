...
let RecepcionProducto = class RecepcionProducto extends _baseentity.BaseEntity {
};
_ts_decorate([
    (0, _typeorm.Column)({
        name: 'recepcion_id'
...
], RecepcionProducto.prototype, "recepcionId", void 0);
_ts_decorate([
    (0, _typeorm.Column)({
        name: 'pedido_producto_id'
    }),
    _ts_metadata("design:type", String)
], RecepcionProducto.prototype, "pedidoProductoId", void 0);
_ts_decorate([
    (0, _typeorm.ManyToOne)(()=>_recepcionentity.Recepcion, (recepcion)=>recepcion.recepcionProductos, {
        onDelete: 'CASCADE',
        nullable: false
    }),
...
], RecepcionProducto.prototype, "recepcion", void 0);
_ts_decorate([
    ...
    _ts_metadata("design:type", typeof Relation === "undefined" ? Object : Relation)
], RecepcionProducto.prototype, "pedidoProducto", void 0);
_ts_decorate([
    (0, _typeorm.Column)({
        type: 'numeric',
        precision: 12,
...
], RecepcionProducto.prototype, "cantidadRecibida", void 0);
_ts_decorate([
    (0, _typeorm.Column)({
        type: 'text',
        nullable: true
    ...
    _ts_metadata("design:type", String)
], RecepcionProducto.prototype, "observaciones", void 0);
_ts_decorate([
    (0, _typeorm.Column)({
...
], RecepcionProducto.prototype, "fechaRecepcion", void 0);
_ts_decorate([
    (0, _typeorm.Column)({
...
], RecepcionProducto.prototype, "isWeighedWithScale", void 0);
...
//# sourceMappingURL=recepcion-producto.entity.js.map