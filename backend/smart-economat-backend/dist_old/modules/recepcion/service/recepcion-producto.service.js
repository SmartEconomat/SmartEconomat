...
let RecepcionProductoService = class RecepcionProductoService {
    async create(dto) {
        ...
        if (!pedidoProducto) {
            throw new _common.NotFoundException(_i18nhelper.I18nHelper.getError('PEDIDO_PRODUCT_NOT_FOUND'));
        }
    ...
    async findOne(id) {
        ...
        if (!recepcionProducto) {
            throw new _common.NotFoundException(_i18nhelper.I18nHelper.getError('RECEPTION_PRODUCT_NOT_FOUND'));
        }
    ...
    constructor(recepcionProductoRepository, recepcionRepository, pedidoProductoRepository){
...
RecepcionProductoService = _ts_decorate([
    ...
    _ts_param(0, (0, _typeorm.InjectRepository)(_recepcionproductoentity.RecepcionProducto)),
    _ts_param(1, (0, _typeorm.InjectRepository)(_recepcionentity.Recepcion)),
    _ts_param(2, (0, _typeorm.InjectRepository)(_pedidoproductoentity.PedidoProducto)),
...
//# sourceMappingURL=recepcion-producto.service.js.map