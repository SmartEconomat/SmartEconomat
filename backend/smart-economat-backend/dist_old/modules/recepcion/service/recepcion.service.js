...
let RecepcionService = class RecepcionService {
    async create(dto, userId) {
        ...
        if (!usuario) {
            throw new _common.BadRequestException(_i18nhelper.I18nHelper.getError('USER_DOES_NOT_EXIST'));
        }
        ...
        await this.movimientoHelper.trackRecepcion(userId, savedRecepcion.id, 0, undefined, undefined, `Recepción creada: ${savedRecepcion.observaciones || 'Sin observaciones'}`);
    ...
    async remove(id) {
        ...
        if (recepcion.recepcionesPedidos?.length || recepcion.recepcionProductos?.length) {
            throw new _common.BadRequestException(_i18nhelper.I18nHelper.getError('RECEPTION_HAS_RELATIONS'));
        }
...
//# sourceMappingURL=recepcion.service.js.map