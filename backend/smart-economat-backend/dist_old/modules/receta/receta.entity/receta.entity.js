...
_ts_decorate([
    ...
    _ts_metadata("design:type", String)
], Receta.prototype, "instrucciones", void 0);
_ts_decorate([
    (0, _typeorm.Column)({
        type: 'enum',
...
], Receta.prototype, "tiempo", void 0);
_ts_decorate([
    (0, _typeorm.Column)({
        type: 'enum',
...
], Receta.prototype, "dificultad", void 0);
_ts_decorate([
    (0, _typeorm.Column)({
    ...
    _ts_metadata("design:type", String)
], Receta.prototype, "tiempoPreparacion", void 0);
_ts_decorate([
    (0, _typeorm.Column)({
    ...
    _ts_metadata("design:type", String)
], Receta.prototype, "productoResultadoId", void 0);
_ts_decorate([
...
], Receta.prototype, "productoResultado", void 0);
_ts_decorate([
    (0, _typeorm.Column)({
        type: 'numeric',
        precision: 12,
...
_ts_decorate([
    ...
    _ts_metadata("design:type", Object)
], Receta.prototype, "unidadResultado", void 0);
_ts_decorate([
    (0, _typeorm.Column)({
        type: 'integer',
        nullable: true,
    ...
    _ts_metadata("design:type", Object)
], Receta.prototype, "diasCaducidad", void 0);
_ts_decorate([
    (0, _typeorm.Column)({
        type: 'numeric',
        precision: 12,
    ...
    _ts_metadata("design:type", Object)
], Receta.prototype, "costeUnitarioEstimado", void 0);
_ts_decorate([
    (0, _typeorm.OneToMany)(()=>_recetaingredienteentity.RecetaIngrediente, (ri)=>ri.receta),
    _ts_metadata("design:type", typeof Relation === "undefined" ? Object : Relation)
