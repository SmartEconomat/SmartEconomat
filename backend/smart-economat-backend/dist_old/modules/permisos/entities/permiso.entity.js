...
_ts_decorate([
    (0, _typeorm.ManyToMany)(()=>_rolentity.Rol, (rol)=>rol.permisos),
    _ts_metadata("design:type", Array)
], Permiso.prototype, "roles", void 0);
_ts_decorate([
    (0, _typeorm.ManyToMany)('Usuario', 'permisosAdicionales'),
    _ts_metadata("design:type", Array)
], Permiso.prototype, "usuariosAdicionales", void 0);
_ts_decorate([
    (0, _typeorm.ManyToMany)('Usuario', 'permisosExcluidos'),
    _ts_metadata("design:type", Array)
], Permiso.prototype, "usuariosExcluidos", void 0);
Permiso = _ts_decorate([
    (0, _typeorm.Entity)({
        name: 'permiso'
    }),
    (0, _typeorm.Index)('idx_permiso_codigo', [
        'codigo'
    ]),
    (0, _typeorm.Index)('idx_permiso_modulo', [
        'modulo'
    ]),
    (0, _typeorm.Index)('idx_permiso_activo', [
        'activo'
    ])
], Permiso);
