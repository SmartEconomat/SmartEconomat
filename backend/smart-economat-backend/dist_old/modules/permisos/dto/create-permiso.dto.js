...
_ts_decorate([
    ...
    (0, _classvalidator.Matches)(/^[a-z_]+:[a-z_]+$/, {
        message: 'El código debe tener el formato "modulo:accion" (solo minúsculas y guiones bajos)'
    }),
...
_ts_decorate([
    ...
    _ts_metadata("design:type", String)
], CreatePermisoDto.prototype, "nombre", void 0);
_ts_decorate([
...
_ts_decorate([
    ...
    _ts_metadata("design:type", String)
], CreatePermisoDto.prototype, "modulo", void 0);
_ts_decorate([
    (0, _swagger.ApiProperty)({
