    ...
    if (dto.plantillaPadreId) {
      ...
      if (!padre) {
        throw new _common.NotFoundException(
          _i18nhelper.I18nHelper.getError('PLANTILLA_PADRE_NO_ENCONTRADA')
        );
      }
    }
  ...
  async update(id, dto) {
    ...
    if (!plantilla.esEditable) {
      throw new _common.BadRequestException(
        _i18nhelper.I18nHelper.getError('ESTA_PLANTILLA_NO_ES_EDITABLE')
      );
    }
...
PlantillasRolesService = _ts_decorate(
  [
    ...
    _ts_param(
      0,
      (0, _typeorm.InjectRepository)(_plantillarolentity.PlantillaRol)
    ),
