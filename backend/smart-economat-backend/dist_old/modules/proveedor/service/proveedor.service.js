...
let ProveedorService = class ProveedorService {
    async create(createProveedorDto) {
        ...
        if (existingNombre) {
            throw new _common.BadRequestException(_i18nhelper.I18nHelper.getError('DUPLICATE_ENTRY'));
        }
        if (nif) {
    ...
    async findOne(id) {
        ...
        if (!proveedor) {
            throw new _common.NotFoundException(_i18nhelper.I18nHelper.getError('PROVIDER_NOT_FOUND'));
        }
        return {
            ...proveedor,
            productos: proveedor.productos || []
    ...
    async remove(id) {
        ...
        if (proveedor.productos && proveedor.productos.length > 0 || proveedor.pedidos && proveedor.pedidos.length > 0) {
            throw new _common.BadRequestException(_i18nhelper.I18nHelper.getError('ENTITY_HAS_RELATIONS'));
        }
...
ProveedorService = _ts_decorate([
    ...
    _ts_metadata("design:paramtypes", [
        typeof _proveedorrepository.ProveedorRepository === "undefined" ? Object : _proveedorrepository.ProveedorRepository
    ])
], ProveedorService);
