...
_ts_decorate([
    ...
    _ts_metadata("design:paramtypes", [
        typeof _createprofesordto.CreateProfesorDto === "undefined" ? Object : _createprofesordto.CreateProfesorDto
    ]),
    _ts_metadata("design:returntype", Promise)
], ProfesorController.prototype, "register", null);
_ts_decorate([
    (0, _common.Post)('slots'),
    (0, _requirepermissionsdecorator.RequirePermissions)('profesor:gestionar_slots'),
    _ts_param(0, (0, _getuserdecorator.GetUser)('id')),
    _ts_param(1, (0, _common.Body)()),
    _ts_metadata("design:type", Function),
    _ts_metadata("design:paramtypes", [
        String,
        typeof _createslotdto.CreateSlotDto === "undefined" ? Object : _createslotdto.CreateSlotDto
    ]),
    _ts_metadata("design:returntype", Promise)
], ProfesorController.prototype, "createSlot", null);
_ts_decorate([
    (0, _common.Patch)('alumnos/:id/activate'),
    (0, _requirepermissionsdecorator.RequirePermissions)('profesor:gestionar_alumnos'),
    _ts_param(0, (0, _getuserdecorator.GetUser)('id')),
    ...
    _ts_metadata("design:returntype", Promise)
], ProfesorController.prototype, "activateAlumno", null);
_ts_decorate([
    (0, _common.Get)('alumnos'),
    (0, _requirepermissionsdecorator.RequirePermissions)('profesor:ver_alumnos'),
    _ts_param(0, (0, _getuserdecorator.GetUser)('id')),
    _ts_metadata("design:type", Function),
    _ts_metadata("design:paramtypes", [
        String
    ...
    _ts_metadata("design:returntype", Promise)
], ProfesorController.prototype, "getAlumnos", null);
_ts_decorate([
    ...
    _ts_metadata("design:returntype", Promise)
], ProfesorController.prototype, "forcePasswordReset", null);
ProfesorController = _ts_decorate([
    ...
    _ts_metadata("design:type", Function),
    _ts_metadata("design:paramtypes", [
        typeof _profesorservice.ProfesorService === "undefined" ? Object : _profesorservice.ProfesorService
    ])
], ProfesorController);
