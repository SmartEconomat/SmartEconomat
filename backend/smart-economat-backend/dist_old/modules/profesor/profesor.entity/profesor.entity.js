...
_ts_decorate([
    (0, _typeorm.OneToOne)(()=>_usuarioentity.Usuario, (u)=>u.profesor),
    (0, _typeorm.JoinColumn)({
        name: 'user_id'
    }),
    _ts_metadata("design:type", typeof Relation === "undefined" ? Object : Relation)
], Profesor.prototype, "user", void 0);
_ts_decorate([
    (0, _typeorm.Column)({
        unique: true
    }),
    _ts_metadata("design:type", String)
], Profesor.prototype, "cial", void 0);
_ts_decorate([
    (0, _typeorm.OneToMany)(()=>_alumnoslotentity.AlumnoSlot, (slot)=>slot.profesor),
    _ts_metadata("design:type", typeof Relation === "undefined" ? Object : Relation)
], Profesor.prototype, "slots", void 0);
_ts_decorate([
    (0, _typeorm.OneToMany)(()=>_alumnoentity.Alumno, (alumno)=>alumno.profesor),
    _ts_metadata("design:type", typeof Relation === "undefined" ? Object : Relation)
], Profesor.prototype, "alumnos", void 0);
Profesor = _ts_decorate([
    (0, _typeorm.Entity)('profesor'),
    (0, _typeorm.Index)('idx_profesor_user', [
        'user'
    ], {
        unique: true
    })
