...
let InventarioRepository = class InventarioRepository extends _typeorm.Repository {
    ...
    async findStockBajo() {
        return this.createQueryBuilder('inventario').where('inventario.cantidad_actual < inventario.cantidad_minima').leftJoinAndSelect('inventario.productoProveedor', 'productoProveedor').leftJoinAndSelect('productoProveedor.producto', 'producto').leftJoinAndSelect('productoProveedor.proveedor', 'proveedor').getMany();
    }
    ...
    constructor(dataSource){
        super(_inventarioentity.Inventario, dataSource.createEntityManager()), this.dataSource = dataSource;
    }
};
