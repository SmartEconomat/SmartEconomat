...
let InventarioService = class InventarioService {
    ...
    try {
      ...
      if (err instanceof _typeorm1.QueryFailedError) {
        throw new _common.BadRequestException(
          _i18nhelper.I18nHelper.getError('INVENTARIO_CONSTRAINT_VIOLATION')
        );
      }
      throw err;
    }
  ...
  async findOne(id) {
    ...
    if (!inventario) {
      throw new _common.NotFoundException(
        _i18nhelper.I18nHelper.getError('INVENTARIO_NOT_FOUND')
      );
    }
    return inventario;
  }
...
InventarioService = _ts_decorate(
  [
    ...
    _ts_metadata('design:paramtypes', [
      typeof _inventariorepository.InventarioRepository === 'undefined'
        ? Object
