...
_ts_decorate([
    (0, _typeorm.Index)('idx_usuario_status', [
        'status'
    ]),
    (0, _typeorm.Column)({
        type: 'enum',
...
_ts_decorate([
    (0, _typeorm.OneToMany)(()=>_pedidoentity.Pedido, (pedido)=>pedido.usuario),
    _ts_metadata("design:type", typeof Relation === "undefined" ? Object : Relation)
], Usuario.prototype, "pedidos", void 0);
_ts_decorate([
    (0, _typeorm.OneToMany)(()=>_recepcionentity.Recepcion, (recepcion)=>recepcion.usuario),
    _ts_metadata("design:type", typeof Relation === "undefined" ? Object : Relation)
], Usuario.prototype, "recepciones", void 0);
_ts_decorate([
    (0, _typeorm.OneToMany)(()=>_movimientoentity.Movimiento, (mov)=>mov.usuario),
    _ts_metadata("design:type", typeof Relation === "undefined" ? Object : Relation)
], Usuario.prototype, "movimientos", void 0);
_ts_decorate([
    (0, _typeorm.OneToMany)(()=>_incidenciaentity.Incidencia, (incidencia)=>incidencia.usuarioResolutor),
    _ts_metadata("design:type", typeof Relation === "undefined" ? Object : Relation)
], Usuario.prototype, "incidenciasResueltas", void 0);
_ts_decorate([
    (0, _typeorm.OneToMany)(()=>_archivoentity.Archivo, (archivo)=>archivo.usuario),
    _ts_metadata("design:type", typeof Relation === "undefined" ? Object : Relation)
], Usuario.prototype, "archivos", void 0);
_ts_decorate([
    (0, _typeorm.OneToOne)(()=>_profesorentity.Profesor, (profesor)=>profesor.user),
    _ts_metadata("design:type", typeof Relation === "undefined" ? Object : Relation)
], Usuario.prototype, "profesor", void 0);
_ts_decorate([
    (0, _typeorm.OneToOne)(()=>_alumnoentity.Alumno, (alumno)=>alumno.user),
    _ts_metadata("design:type", typeof Relation === "undefined" ? Object : Relation)
], Usuario.prototype, "alumno", void 0);
_ts_decorate([
    (0, _typeorm.ManyToMany)(()=>_rolentity.Rol, (rol)=>rol.usuarios),
...
_ts_decorate([
    ...
    _ts_metadata("design:type", Array)
], Usuario.prototype, "permisosAdicionales", void 0);
_ts_decorate([
    (0, _typeorm.ManyToMany)(()=>_permisoentity.Permiso),
    (0, _typeorm.JoinTable)({
    ...
    _ts_metadata("design:type", Array)
], Usuario.prototype, "permisosExcluidos", void 0);
_ts_decorate([
    (0, _typeorm.Column)({
        type: 'boolean',
        default: true
