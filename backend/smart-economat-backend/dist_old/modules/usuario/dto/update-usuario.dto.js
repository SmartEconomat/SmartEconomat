...
], UpdateUsuarioDto.prototype, "status", void 0);
_ts_decorate([
    (0, _classvalidator.IsOptional)(),
    (0, _classtransformer.Transform)(_trimstringtransformer.TrimStringTransformer.transform),
    (0, _classvalidator.IsString)({
        message: (0, _nestjsi18n.i18nValidationMessage)('validation.EL_CIAL_DEBE_SER_UNA_CADENA_DE_TEXTO')
    }),
    (0, _classvalidator.MaxLength)(100),
    _ts_metadata("design:type", String)
], UpdateUsuarioDto.prototype, "cialProfesor", void 0);
_ts_decorate([
    (0, _classvalidator.IsOptional)(),
    (0, _classtransformer.Transform)(_trimstringtransformer.TrimStringTransformer.transform),
    (0, _classvalidator.IsString)({
        message: (0, _nestjsi18n.i18nValidationMessage)('validation.EL_N_MERO_DE_CLASE_DEBE_SER_UNA_CADENA_D')
    }),
    (0, _classvalidator.MaxLength)(10),
    _ts_metadata("design:type", String)
], UpdateUsuarioDto.prototype, "numeroClase", void 0);
_ts_decorate([
    (0, _classvalidator.IsOptional)(),
    (0, _classtransformer.Transform)(_trimstringtransformer.TrimStringTransformer.transform),
    (0, _classvalidator.IsString)({
        message: (0, _nestjsi18n.i18nValidationMessage)('validation.EL_AULA_DEBE_SER_UNA_CADENA_DE_TEXTO')
    }),
    (0, _classvalidator.MaxLength)(50),
    _ts_metadata("design:type", String)
], UpdateUsuarioDto.prototype, "aula", void 0);
