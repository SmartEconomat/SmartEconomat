...
let PedidoService = class PedidoService {
  ...
  async update(id, updatePedidoDto) {
    ...
    if (
      ...
      await this.pedidoRepository.manager.delete(
  ...
  async cancelarPedido(id, dto) {
    ...
    if (
      ...
      throw new _common.BadRequestException(
        _i18nhelper.I18nHelper.getError('ORDER_NOT_CANCELLABLE')
      );
    }
  ...
  async remove(id) {
    ...
    if (
      ...
      pedido.estado !== _estadopedidoenum.EstadoPedido.CANCELADO
    ) {
      throw new _common.BadRequestException(
        _i18nhelper.I18nHelper.getError('ORDER_CANNOT_BE_DELETED')
      );
    }
...
PedidoService = _ts_decorate(
  [
    ...
    _ts_metadata('design:paramtypes', [
      typeof _pedidorepository.PedidoRepository === 'undefined'
        ? Object
