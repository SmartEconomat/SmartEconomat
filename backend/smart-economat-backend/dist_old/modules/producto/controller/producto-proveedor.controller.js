...
_ts_decorate(
  [
    ...
    _ts_metadata('design:paramtypes', [
      String,
      typeof _updateprecioproductodto.UpdatePrecioProductoDto === 'undefined'
        ? Object
        : _updateprecioproductodto.UpdatePrecioProductoDto,
    ]),
    _ts_metadata('design:returntype', Promise),
  ],
  ProductoProveedorController.prototype,
  'updatePrecio',
  null
);
_ts_decorate(
  [
    ...
    _ts_metadata('design:type', Function),
    _ts_metadata('design:paramtypes', [
      typeof _searchproductoproveedordto.SearchProductoProveedorDto ===
      'undefined'
        ? Object
        : _searchproductoproveedordto.SearchProductoProveedorDto,
    ]),
    _ts_metadata('design:returntype', Promise),
  ],
  ProductoProveedorController.prototype,
...
_ts_decorate(
  [
    ...
    (0, _swagger.ApiResponse)({
      ...
      type: [_historialentity.HistorialPrecio],
    }),
    (0, _swagger.ApiResponse)({
      status: _common.HttpStatus.NOT_FOUND,
      description: 'docs.PRODUCTO_PROVEEDOR_NO_ENCONTRADO',
...
ProductoProveedorController = _ts_decorate(
  [
    ...
    _ts_metadata('design:type', Function),
    _ts_metadata('design:paramtypes', [
      typeof _productoproveedorservice.ProductoProveedorService === 'undefined'
        ? Object
