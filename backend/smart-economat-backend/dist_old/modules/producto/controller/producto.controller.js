...
], ProductoController.prototype, "generarEan13", null);
_ts_decorate([
    (0, _common.Post)(),
    (0, _requirepermissionsdecorator.RequirePermissions)('productos:crear'),
    (0, _common.HttpCode)(_common.HttpStatus.CREATED),
    (0, _swagger.ApiOperation)({
        summary: 'Crear un nuevo producto con opcionalmente alérgenos y proveedores'
    }),
    (0, _swagger.ApiResponse)({
        status: 201,
    ...
    _ts_metadata("design:type", Function),
    _ts_metadata("design:paramtypes", [
        typeof _createproductodto.CreateProductoDto === "undefined" ? Object : _createproductodto.CreateProductoDto,
        Object
    ]),
...
_ts_decorate([
    ...
    _ts_metadata("design:type", Function),
    _ts_metadata("design:paramtypes", [
        typeof _productfilterdto.ProductFilterDto === "undefined" ? Object : _productfilterdto.ProductFilterDto
    ]),
    _ts_metadata("design:returntype", typeof Promise === "undefined" ? Object : Promise)
...
_ts_decorate([
    ...
    _ts_metadata("design:paramtypes", [
        String,
        typeof _updateproductodto.UpdateProductoDto === "undefined" ? Object : _updateproductodto.UpdateProductoDto,
        Object
    ]),
    _ts_metadata("design:returntype", typeof Promise === "undefined" ? Object : Promise)
...
ProductoController = _ts_decorate([
    ...
    _ts_metadata("design:type", Function),
    _ts_metadata("design:paramtypes", [
        typeof _productoservice.ProductoService === "undefined" ? Object : _productoservice.ProductoService
    ])
], ProductoController);
