...
let HistorialPrecioService = class HistorialPrecioService {
    async create(dto) {
        const productoProveedor = await this.dataSource.manager.findOne(_productoproveedorentity.ProductoProveedor, {
            where: {
        ...
        if (dto.precio < 0) {
            throw new _common.BadRequestException(_i18nhelper.I18nHelper.getError('PRECIO_NO_NEGATIVO'));
        }
    ...
    async findOne(id) {
        const historial = await this.historialPrecioRepository.findOneWithRelations(id);
        if (!historial) {
            throw new _common.NotFoundException(_i18nhelper.I18nHelper.getError('HISTORIAL_PRECIO_NOT_FOUND'));
        }
        return historial;
    }
    async update(id, dto) {
        ...
        if (dto.precio !== undefined) {
            if (dto.precio === null) {
                throw new _common.BadRequestException(_i18nhelper.I18nHelper.getError('INVALID_DATA'));
            }
            if (dto.precio < 0) {
                throw new _common.BadRequestException(_i18nhelper.I18nHelper.getError('PRECIO_NO_NEGATIVO'));
            }
...
HistorialPrecioService = _ts_decorate([
    ...
    _ts_metadata("design:paramtypes", [
        typeof _historialpreciorepository.HistorialPrecioRepository === "undefined" ? Object : _historialpreciorepository.HistorialPrecioRepository,
        typeof _typeorm.DataSource === "undefined" ? Object : _typeorm.DataSource
    ])
], HistorialPrecioService);

//# sourceMappingURL=historial-precio.service.js.map