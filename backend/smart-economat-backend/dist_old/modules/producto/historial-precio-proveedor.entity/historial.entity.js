...
], HistorialPrecio.prototype, "productoProveedorId", void 0);
_ts_decorate([
    (0, _typeorm.ManyToOne)(()=>_productoproveedorentity.ProductoProveedor, (pp)=>pp.historialPrecios, {
        onDelete: 'CASCADE',
        nullable: false
    }),
...
], HistorialPrecio.prototype, "productoProveedor", void 0);
_ts_decorate([
    (0, _typeorm.Column)({
        type: 'numeric',
        precision: 10,
...
], HistorialPrecio.prototype, "precio", void 0);
_ts_decorate([
    (0, _typeorm.Column)({
        type: 'timestamptz',
...
], HistorialPrecio.prototype, "fecha", void 0);
