...
let ProductFilterDto = class ProductFilterDto extends _paginationquerydto.PaginationQueryDto {
};
_ts_decorate([
...
_ts_decorate([
    ...
    (0, _classtransformer.Transform)(({ value })=>Array.isArray(value) ? value : typeof value === 'string' ? value.split(',') : []),
    _ts_metadata("design:type", Array)
], ProductFilterDto.prototype, "alergenos", void 0);
_ts_decorate([
    (0, _classvalidator.IsOptional)(),
    (0, _classvalidator.IsArray)(),
    ...
    (0, _classtransformer.Transform)(({ value })=>Array.isArray(value) ? value : typeof value === 'string' ? value.split(',') : []),
    _ts_metadata("design:type", Array)
], ProductFilterDto.prototype, "categorias", void 0);
_ts_decorate([
    (0, _classvalidator.IsOptional)(),
    (0, _classvalidator.IsArray)(),
    ...
    (0, _classtransformer.Transform)(({ value })=>Array.isArray(value) ? value : typeof value === 'string' ? value.split(',') : []),
    _ts_metadata("design:type", Array)
], ProductFilterDto.prototype, "marcas", void 0);
