...
_ts_decorate(
  ...
  SearchProductoProveedorDto.prototype,
  'q',
  void 0
);
_ts_decorate(
  [
    ...
    (0, _classvalidator.IsInt)({
      message: (0, _nestjsi18n.i18nValidationMessage)(
        'validation.EL_OFFSET_DEBE_SER_UN_ENTERO'
      ),
    }),
...
_ts_decorate(
  [
    ...
    (0, _classvalidator.IsInt)({
      message: (0, _nestjsi18n.i18nValidationMessage)(
        'validation.EL_L_MITE_DEBE_SER_UN_ENTERO'
      ),
    }),
    (0, _classvalidator.Min)(1, {
      message: (0, _nestjsi18n.i18nValidationMessage)(
        'validation.EL_L_MITE_DEBE_SER_AL_MENOS_1'
      ),
    }),
    (0, _classvalidator.Max)(50, {
      message: (0, _nestjsi18n.i18nValidationMessage)(
        'validation.EL_L_MITE_NO_PUEDE_EXCEDER_50'
      ),
    }),
    _ts_metadata('design:type', Number),
  ],
