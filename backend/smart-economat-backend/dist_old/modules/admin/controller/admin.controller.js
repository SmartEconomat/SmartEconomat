...
], AdminController.prototype, "createProfesor", null);
_ts_decorate([
    (0, _common.Patch)('users/:id/activate'),
    (0, _requirepermissionsdecorator.RequirePermissions)('usuarios:activar_desactivar'),
...
_ts_decorate([
    ...
    (0, _requirepermissionsdecorator.RequirePermissions)('usuarios:resetear_password'),
    _ts_param(0, (0, _common.Param)('id')),
    _ts_metadata("design:type", Function),
    _ts_metadata("design:paramtypes", [
        String
