...
_ts_decorate([
    (0, _typeorm.OneToOne)(()=>_usuarioentity.Usuario, (u)=>u.alumno),
    (0, _typeorm.JoinColumn)({
        name: 'user_id'
    }),
    _ts_metadata("design:type", typeof Relation === "undefined" ? Object : Relation)
], Alumno.prototype, "user", void 0);
_ts_decorate([
    (0, _typeorm.OneToOne)(()=>_alumnoslotentity.AlumnoSlot, (slot)=>slot.alumno),
    (0, _typeorm.JoinColumn)({
        name: 'slot_id'
    }),
    _ts_metadata("design:type", typeof Relation === "undefined" ? Object : Relation)
], Alumno.prototype, "slot", void 0);
_ts_decorate([
    (0, _typeorm.ManyToOne)(()=>_profesorentity.Profesor, (profesor)=>profesor.alumnos),
    (0, _typeorm.JoinColumn)({
        name: 'profesor_id'
    }),
    _ts_metadata("design:type", typeof Relation === "undefined" ? Object : Relation)
], Alumno.prototype, "profesor", void 0);
Alumno = _ts_decorate([
    (0, _typeorm.Entity)('alumno'),
    (0, _typeorm.Index)('idx_alumno_user', [
        'user'
    ], {
        unique: true
    }),
    (0, _typeorm.Index)('idx_alumno_slot', [
        'slot'
    ], {
        unique: true
    })
