...
async function bootstrap() {
  ...
  const config = new _swagger.DocumentBuilder()
  ...
  app.useGlobalPipes(
    new _nestjsi18n.I18nValidationPipe({
      whitelist: true,
  ...
  app.useGlobalInterceptors(
    new _common.ClassSerializerInterceptor(app.get(_core.Reflector)),
    new _transforminterceptor.TransformInterceptor()
  );
