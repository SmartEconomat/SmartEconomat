...
let NormalizeDataPipe = class NormalizeDataPipe {
    async transform(value, metadata) {
        ...
        if (metadata.metatype) {
            const transformed = (0, _classtransformer.plainToInstance)(metadata.metatype, value, {
            ...
            if (errors.length > 0) {
                ...
                throw new _common.BadRequestException(_i18nhelper.I18nHelper.getError('VALIDACION_FALLIDA') + `: ${errorMessages}`);
            }
            return transformed;
        }
...
//# sourceMappingURL=normalize-data.pipe.js.map