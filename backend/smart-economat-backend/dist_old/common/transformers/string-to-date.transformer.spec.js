 ...
 */ describe('StringToDateTransformer', () => {
  describe('transform()', () => {
    it('debe convertir string ISO a Date', () => {
      ...
      const result =
        _stringtodatetransformer.StringToDateTransformer.transform(params);
    ...
    it('debe lanzar error si la fecha es inválida', () => {
      ...
      expect(() =>
        _stringtodatetransformer.StringToDateTransformer.transform(params)
      ).toThrow("El valor 'fecha-invalida' no puede ser convertido a fecha");
    });
    it('debe lanzar error si el timestamp es NaN', () => {
      ...
      expect(() =>
        _stringtodatetransformer.StringToDateTransformer.transform(params)
      ).toThrow("El timestamp 'NaN' no es una fecha válida");
    });
