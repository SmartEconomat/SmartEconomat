 ...
 */ describe('NormalizeArrayTransformer', ()=>{
    describe('transform()', ()=>{
        it('debe manejar array de strings', ()=>{
            ...
            expect(_normalizearraytransformer.NormalizeArrayTransformer.transform(params)).toEqual([
                'apple',
                'banana',
                'cherry'
            ]);
        ...
        it('debe manejar string vacío', ()=>{
            ...
            expect(_normalizearraytransformer.NormalizeArrayTransformer.transform(params)).toBeUndefined();
        });
        ...
        it('debe retornar null si el valor es null', ()=>{
            ...
            expect(_normalizearraytransformer.NormalizeArrayTransformer.transform(params)).toBeNull();
        });
...
//# sourceMappingURL=normalize-array.transformer.spec.js.map