...
function Trim() {
  return (0, _classtransformer.Transform)(
    _trimstringtransformer.TrimStringTransformer.transform
  );
}
function ToUppercase() {
  return (0, _classtransformer.Transform)(
    _uppercasestringtransformer.UppercaseStringTransformer.transform
  );
}
...
function NormalizeNumber() {
  return (0, _classtransformer.Transform)(
    _stringtonumbertransformer.StringToNumberTransformer.transform
  );
}
...
function NormalizeArray() {
  return (0, _classtransformer.Transform)(
    _normalizearraytransformer.NormalizeArrayTransformer.transform
  );
}
