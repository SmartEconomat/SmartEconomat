 ...
 */ const PG_ERROR_KEYS = {
    /** Foreign key violation: el registro está referenciado en otra tabla. */ '23503': 'errors.ENTITY_HAS_RELATIONS',
    /** Unique constraint violation: el valor ya existe. */ '23505': 'errors.DUPLICATE_ENTRY'
};
let GlobalExceptionFilter = class GlobalExceptionFilter {
        ...
        const requestId = request.headers['x-request-id'] || (0, _nodecrypto.randomUUID)();
        ...
        if (exception instanceof _typeorm.QueryFailedError) {
            ...
            if (errorKey) {
                this.logger.warn(`DB constraint violation [${pgCode}]: ${exception.message}`);
                const translatedMessage = i18n ? i18n.translate(`translation.${errorKey}`) : errorKey;
                return this.sendResponse(response, _common.HttpStatus.CONFLICT, translatedMessage, null, requestId);
            }
            this.logger.error(exception);
            const translatedInternalError = i18n ? i18n.translate('translation.errors.INTERNAL_SERVER_ERROR') : 'translation.errors.INTERNAL_SERVER_ERROR';
            return this.sendResponse(response, _common.HttpStatus.INTERNAL_SERVER_ERROR, translatedInternalError, null, requestId);
        }
        ...
        let message = i18n ? i18n.translate('translation.errors.INTERNAL_SERVER_ERROR') : 'translation.errors.INTERNAL_SERVER_ERROR';
        ...
        return this.sendResponse(response, status, message, errorDetails, requestId);
    }
...
], GlobalExceptionFilter.prototype, "catch", null);
