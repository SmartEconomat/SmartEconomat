...
let MovimientoHelper = class MovimientoHelper {
   ...
   */ async trackProductoCreation(userId, productoId, descripcion) {
    return this.createMovimiento(
      userId,
      _movimientoenums.TipoMovimiento.ENTRADA,
      'Producto',
      productoId,
      0,
      undefined,
   ...
   */ async trackProductoUpdate(userId, productoId, descripcion) {
    return this.createMovimiento(
      userId,
      _movimientoenums.TipoMovimiento.AJUSTE,
      'Producto',
      productoId,
      0,
      undefined,
   ...
   */ async trackProductoDeletion(userId, productoId, descripcion) {
    return this.createMovimiento(
      userId,
      _movimientoenums.TipoMovimiento.SALIDA,
      'Producto',
      productoId,
      0,
      undefined,
   ...
   */ async trackPedidoCreation(userId, pedidoId, descripcion) {
    return this.createMovimiento(
      userId,
      _movimientoenums.TipoMovimiento.PEDIDO,
      'Pedido',
      pedidoId,
      0,
      undefined,
   ...
   */ async trackRecepcion(
    ...
    return this.createMovimiento(
      userId,
      _movimientoenums.TipoMovimiento.ENTRADA_COMPRA,
      'Recepcion',
      recepcionId,
      cantidad,
      inventarioId,
