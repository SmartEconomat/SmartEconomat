...
const runSeeder = async (dataSource)=>{
    ...
    await dataSource.query(`TRUNCATE TABLE "inventario" RESTART IDENTITY CASCADE;`);
    ...
    await dataSource.query(`TRUNCATE TABLE "ubicacion" RESTART IDENTITY CASCADE;`);
    ...
    console.log(_seederi18nhelper.SeederI18nHelper.getSeederSuccess('inventario'));
};

//# sourceMappingURL=inventario.seeder.js.map