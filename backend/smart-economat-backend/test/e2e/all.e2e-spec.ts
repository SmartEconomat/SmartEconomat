...
import './auth-multi-user-flows.e2e-spec';
...
import './pedido-draft.e2e-spec';
import './pedidos.e2e-spec';
import './purchase-batch.e2e-spec';
...
import './recepcion-draft.e2e-spec';
import './recepcion.e2e-spec';
import './recetas.e2e-spec';
import './security-lifecycle.e2e-spec';
import './slots-admin.e2e-spec';
import './ubicaciones.e2e-spec';
import './usuarios-validation.e2e-spec';
import './usuarios.e2e-spec';
import './endpoint-inventory-coverage.e2e-spec';
import './export-endpoints-coverage.e2e-spec';
import './critical-modules-security.e2e-spec';
