...
export class BaselineSchema1775000000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "merma" ("id" uuid NOT NULL DEFAULT uuid_generate_v7(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "deleted_by" uuid, "modified_by" uuid, "version" integer NOT NULL DEFAULT '1', "producto_id" uuid NOT NULL, "usuario_id" uuid, "cantidad" numeric(12,3) NOT NULL, "motivo" "public"."merma_motivo_enum" NOT NULL, "tipo" "public"."merma_tipo_enum" NOT NULL DEFAULT 'inventario', "notas" text, "origen_entidad" character varying(50), "origen_id" uuid, "referencia_id" uuid, "idempotency_key" uuid, CONSTRAINT "CHK_58f1ee030ad106613de48cf476" CHECK ("cantidad" > 0), CONSTRAINT "PK_49155afd7ee8855f3ec39ebeedf" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "recepcion_pedido" ("id" uuid NOT NULL DEFAULT uuid_generate_v7(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "deleted_by" uuid, "modified_by" uuid, "version" integer NOT NULL DEFAULT '1', "recepcion_id" uuid NOT NULL, "pedido_id" uuid NOT NULL, "fecha_vinculacion" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "UQ_582a9239e17a2ed19d010fdce25" UNIQUE ("recepcion_id", "pedido_id"), CONSTRAINT "PK_1b3fc0c090a639fbcce70e59f89" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "incidencia" ("id" uuid NOT NULL DEFAULT uuid_generate_v7(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "deleted_by" uuid, "modified_by" uuid, "version" integer NOT NULL DEFAULT '1', "recepcion_id" uuid NOT NULL, "pedido_id" uuid, "usuario_resolutor_id" uuid, "observaciones_recepcion" text, "observaciones_resolucion" text, "fecha_resolucion" TIMESTAMP WITH TIME ZONE, CONSTRAINT "PK_1e98587e9dc53e62e039e0dbabf" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "recepcion" ("id" uuid NOT NULL DEFAULT uuid_generate_v7(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "deleted_by" uuid, "modified_by" uuid, "version" integer NOT NULL DEFAULT '1', "usuario_id" uuid, "fecha_recepcion" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "estado" "public"."recepcion_estado_enum" NOT NULL DEFAULT 'COMPLETADA', "observaciones" text, "incidencia" boolean NOT NULL DEFAULT false, CONSTRAINT "PK_47d2fdb94ecf7269b6c30b6c7c7" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "profesor" ("id" uuid NOT NULL DEFAULT uuid_generate_v7(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "deleted_by" uuid, "modified_by" uuid, "version" integer NOT NULL DEFAULT '1', "cial" character varying NOT NULL, "user_id" uuid, CONSTRAINT "UQ_cd3e623f4e4f99bf9778294a751" UNIQUE ("cial"), CONSTRAINT "REL_8f36295dbf50eacec160ff56ba" UNIQUE ("user_id"), CONSTRAINT "PK_89ab503ec3d28c357d8105f2092" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "idx_profesor_user" ON "profesor" ("user_id") `
    );
    await queryRunner.query(
      `CREATE TABLE "plantilla_rol" ("id" uuid NOT NULL DEFAULT uuid_generate_v7(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "deleted_by" uuid, "modified_by" uuid, "version" integer NOT NULL DEFAULT '1', "nombre" character varying(100) NOT NULL, "descripcion" text, "es_editable" boolean NOT NULL DEFAULT true, "activo" boolean NOT NULL DEFAULT true, "plantilla_padre_id" uuid, CONSTRAINT "UQ_4f9b2c7e6684aef682784361afe" UNIQUE ("nombre"), CONSTRAINT "PK_33e1eca8846f3d176a200a8bbb0" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "receta_ingrediente" ("id" uuid NOT NULL DEFAULT uuid_generate_v7(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "deleted_by" uuid, "modified_by" uuid, "version" integer NOT NULL DEFAULT '1', "receta_id" uuid NOT NULL, "producto_id" uuid NOT NULL, "cantidad" numeric(12,4) NOT NULL, "unidad" "public"."receta_ingrediente_unidad_enum" NOT NULL, "merma_aplicada" numeric(5,2) NOT NULL DEFAULT '0', "proveedor_favorito_id" uuid, CONSTRAINT "PK_e4cf60e3b5465b74b4db01c6222" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "receta" ("id" uuid NOT NULL DEFAULT uuid_generate_v7(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "deleted_by" uuid, "modified_by" uuid, "version" integer NOT NULL DEFAULT '1', "nombre" character varying(150) NOT NULL, "instrucciones" text NOT NULL, "tiempo_estimado_minutos" integer NOT NULL DEFAULT '0', "dificultad" "public"."dificultad_receta_enum" NOT NULL, "path_img" character varying(255), "path_img_optimized" character varying(255), "rendimiento" numeric(12,3), "unidad_resultado" "public"."receta_unidad_resultado_enum", "dias_caducidad" integer, "coste_unitario_estimado" numeric(12,4), "raciones" numeric(12,3) DEFAULT '1', "tamanio_racion" numeric(12,3), CONSTRAINT "PK_f3acd9397b95e92dd92c8b089ce" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "incidencia_resuelta" ("id" uuid NOT NULL DEFAULT uuid_generate_v7(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "deleted_by" uuid, "modified_by" uuid, "version" integer NOT NULL DEFAULT '1', "incidencia_id" uuid NOT NULL, "usuario_resolutor_id" uuid, "tipo_resolucion" "public"."incidencia_resuelta_tipo_resolucion_enum" NOT NULL, "fecha_resolucion" TIMESTAMP WITH TIME ZONE NOT NULL, "observaciones" text, CONSTRAINT "PK_94296b45f68d0028be285d9be1d" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
