...
/** Clase pública (PedidoDraftResponseDto). Paquete: smart-economat-backend (Nest). */
export class PedidoDraftResponseDto {
  @ApiPropertyOptional({
  ...
  @ApiProperty({
    description: 'Payload serializable del formulario de creación de pedido.',
    type: 'object',
