...
export const usuarioService = {
    async getUsuarios(
        ...
        // Simulando paginación/búsqueda en el cliente si el backend no lo hace (o para asegurar coherencia)
        // Nota: Idealmente el backend debería manejar paginación y filtros.
