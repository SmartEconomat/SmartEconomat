...
import { Box, Typography, Paper, Alert, IconButton, InputAdornment, Container } from '@mui/material';
...
const ResetPassword: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (res.success) {
                setSuccessMsg('Tu contraseña ha sido restablecida correctamente. Serás redirigido al inicio de sesión.');
