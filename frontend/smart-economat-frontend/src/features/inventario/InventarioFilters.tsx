                    ...
                    tagValue.map((option, index) => {
                        ...
                        return (
                            <Chip
                                ...
                                size="small"
                                icon={
                                    <Box component="span" sx={{ display: 'flex', ml: '4px !important', mr: '-2px', '& svg': { fontSize: 13 } }}>
                            ...
                            startAdornment: (
                                <>
                                    <InputAdornment position="start" sx={{ ml: 0.5 }}>
                                        <FilterListIcon sx={{ fontSize: 18, color: selectedCategorias.length > 0 ? 'primary.main' : 'action.active' }} />
                                    </InputAdornment>
                    ...
                    <TextField
                        ...
                        InputProps={{
                            ...
                            startAdornment: (
                                <>
                                    <InputAdornment position="start" sx={{ ml: 0.5 }}>
                                        <PlaceIcon sx={{ fontSize: 18, color: selectedUbicaciones.length > 0 ? 'primary.main' : 'action.active' }} />
                                    </InputAdornment>
                                    {params.InputProps.startAdornment}
                                </>
                            )
