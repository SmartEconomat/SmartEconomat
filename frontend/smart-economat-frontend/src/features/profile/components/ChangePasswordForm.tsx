...
import { Box, Typography, Card, CardContent, Divider, Alert, InputAdornment, IconButton } from '@mui/material';
...
const ChangePasswordForm: React.FC = () => {
    ...
    React.useEffect(() => {
        if (formData.newPassword) {
            setPasswordLengthValid(formData.newPassword.length >= 6);
        } else {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setError(err.message || 'Error al actualizar la contraseña. Verifica tu contraseña actual.');
                    ...
                    >
                        ...
                        <Box>
                            <Input
                                ...
                                helperText={
                                    passwordLengthValid === false ? "Mínimo 6 caracteres" :
                                        passwordLengthValid === true ? "Longitud correcta" : " "
                                }
                                FormHelperTextProps={{
                                    sx: {
                                        color: passwordLengthValid === false ? 'error.main' :
                                            passwordLengthValid === true ? 'success.main' : 'text.secondary'
                                    }
                                }}
                            />
                        </Box>
                        <Box>
                            <Input
                                ...
                                FormHelperTextProps={{
                                    sx: { color: passwordsMatch === false ? 'error.main' : 'success.main' }
                                }}
                            />
                        </Box>
                    </Box>
