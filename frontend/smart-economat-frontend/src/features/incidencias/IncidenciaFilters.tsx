...
const IncidenciaFilters: React.FC<IncidenciaFiltersProps> = ({ filters, onChange }) => {

    const handleStatusChange = (_: any, newValue: { label: string, value: boolean } | null) => {
    ...
    return (
        <Box sx={{
            ...
            <Autocomplete
                ...
                value={STATUS_OPTIONS.find(opt => opt.value === filters.resuelta) || null}
                ...
                renderInput={(params) => (
                    <TextField
                        ...
                        InputProps={{
                            ...
                            startAdornment: (
                                <>
                                    <FilterListIcon sx={{ color: 'text.secondary', mr: 1, ml: 0.5 }} fontSize="small" />
