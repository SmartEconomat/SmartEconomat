    ...
    return (
        <Chip
            ...
            sx={{
                ...
                color: (theme) => theme.palette.mode === 'dark' && color !== 'default' ? theme.palette[color].light : undefined,
                borderColor: (theme) => theme.palette.mode === 'dark' && color !== 'default' ? theme.palette[color].light : undefined,
                px: { xs: 0, sm: 1 },
                '& .MuiChip-icon': {
                    color: 'inherit',
                    ml: { xs: 0, sm: '-4px' },
