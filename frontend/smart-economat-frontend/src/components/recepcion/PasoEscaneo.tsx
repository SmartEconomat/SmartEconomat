...
const PasoEscaneo: React.FC<PasoEscaneoProps> = ({
    ...
    return (
        <Box>
            <Box sx={{ position: 'sticky', top: 0, zIndex: 10, pb: 2, display: 'flex', gap: 2, flexDirection: { xs: 'column', sm: 'row' }, alignItems: { xs: 'stretch', sm: 'center' } }}>
                <TextField
                ...
                />
                <Button variant="contained" onClick={onSearch} disabled={searching} sx={{ px: 4 }}>Añadir</Button>
                <FormControlLabel
                    control={<Switch checked={isScaleConnected} onChange={(e) => setIsScaleConnected(e.target.checked)} color="secondary" />}
                    label={<Typography variant="body2" sx={{ whiteSpace: 'nowrap' }}>Báscula on</Typography>}
                    sx={{ ml: 2, p: 1, border: '1px dashed', borderColor: 'divider', borderRadius: 1 }}
                />
            </Box>
                            ...
                            <Table size="small" sx={{ tableLayout: 'fixed', minWidth: 800 }}>
                                <TableHead>
                                    <TableRow>
                                        ...
                                        <TableCell align="center" sx={{ width: '7%' }}>Unidad</TableCell>
                                        <TableCell align="center" sx={{ width: '8%' }}>Pedida</TableCell>
                                        <TableCell align="center" sx={{ width: '15%' }}>Albarán</TableCell>
                                        <TableCell align="center" sx={{ width: '15%' }}>Recibida</TableCell>
                                        ...
                                        <TableRow key={l.pedidoProductoId} hover>
                                            ...
                                            <TableCell align="right">
                                                <TextField
                                                    ...
                                                    onChange={(e) => onUpdateLinea(pIdx, lIdx, 'cantidadAlbaran', formatNumberInput(e.target.value))}
                                                    InputProps={{
                                                        startAdornment: l.cantidadAlbaran !== '' && l.cantidadAlbaran != null ? (
                                                    ...
                                                    sx={{
                                                        ...
                                                        '& .MuiOutlinedInput-notchedOutline': {
                                                            borderColor: (theme) => {
                                                                if (l.cantidadAlbaran === '' || l.cantidadAlbaran == null) return undefined;
                                                                const numAlbaran = Number(l.cantidadAlbaran);
                                                                if (numAlbaran === l.cantidadPedida) return theme.palette.success.main;
                                                                if (numAlbaran < l.cantidadPedida) return theme.palette.warning.main;
                                                                return theme.palette.info.main;
                                                            },
                                                            borderWidth: l.cantidadAlbaran !== '' && l.cantidadAlbaran != null ? 2 : undefined
                                                        }
                                                    }}
                                                />
                                            </TableCell>
                                            <TableCell align="right">
                                                <TextField
                                                        ...
                                                        endAdornment: (
                                                            <InputAdornment position="end">
                                                                <IconButton
                                                                    ...
                                                                    onClick={(e) => {
                                                                        e.stopPropagation();
                                                                        onUpdateLinea(pIdx, lIdx, 'cantidadRecibida', '');
                                                                    }}
                                                                    edge="end"
                                                                >
                                                    ...
                                                    onKeyDown={handleNumberInputKeyDown}
                                                    onChange={(e) => onUpdateLinea(pIdx, lIdx, 'cantidadRecibida', formatNumberInput(e.target.value))}
                                                    sx={{
                                                        minWidth: 110,
                                                        maxWidth: 130,
                                                        cursor: isWeightUnit(l.unidad) && isScaleConnected ? 'pointer' : 'text',
                                                        '& .MuiInputBase-root': {
                                                            backgroundColor: isWeightUnit(l.unidad) && isScaleConnected ? 'rgba(76, 175, 80, 0.15)' : 'inherit',
                                                            border: isWeightUnit(l.unidad) && isScaleConnected ? '1px solid #4CAF50' : 'none',
                                                            color: isWeightUnit(l.unidad) && isScaleConnected ? '#4CAF50' : 'inherit',
                                                        },
                                                        '& .MuiInputBase-input': {
                                                            cursor: isWeightUnit(l.unidad) && isScaleConnected ? 'pointer' : 'inherit'
                                                        }
                                                    }}
                                                />
                                            </TableCell>
                                            <TableCell>
                                                <FormControl size="small" fullWidth>
                                                    <Select
                                                        ...
                                                        onChange={(e) => onUpdateLinea(pIdx, lIdx, 'estadoVisual', e.target.value)}
                                                        sx={{ fontSize: '0.8rem' }}
                                                    >
                        ...
                        <Table size="small" sx={{ tableLayout: 'fixed', minWidth: 900 }}>
                            <TableHead>
                                <TableRow>
                                    ...
                                    <TableCell align="right" sx={{ width: '17%' }}>Albarán</TableCell>
                                    <TableCell align="right" sx={{ width: '20%' }}>Recibida</TableCell>
                                    <TableCell sx={{ width: '15%' }}>Físico</TableCell>
                                    <TableCell align="center" sx={{ width: '15%' }}>Acción</TableCell>
                                </TableRow>
                            </TableHead>
                            <TableBody>
                                    ...
                                    <TableRow key={lIdx}>
                                        ...
                                        <TableCell align="right">
                                            <TextField
                                                ...
                                                value={l.cantidadAlbaran}
                                                onKeyDown={handleNumberInputKeyDown}
                                                onChange={(e) => onUpdateLinea(null, lIdx, 'cantidadAlbaran', formatNumberInput(e.target.value))}
                                                InputProps={{
                                                    startAdornment: l.cantidadAlbaran !== '' && l.cantidadAlbaran != null ? (
                                                        <InputAdornment position="start">
                                                            <InfoOutlinedIcon color="info" fontSize="small" />
                                        ...
                                        <TableCell align="right">
                                            <TextField
                                                    ...
                                                    endAdornment: (
                                                        <InputAdornment position="end">
                                                            <IconButton
                                                                ...
                                                                onClick={(e) => {
                                                                    e.stopPropagation();
                                                                    onUpdateLinea(null, lIdx, 'cantidadRecibida', '');
                                                                }}
                                                                edge="end"
                                                            >
                                                                <ClearIcon fontSize="small" />
                                                ...
                                                onKeyDown={handleNumberInputKeyDown}
                                                onChange={(e) => onUpdateLinea(null, lIdx, 'cantidadRecibida', formatNumberInput(e.target.value))}
                                                sx={{
                                                    minWidth: 110,
                                                    maxWidth: 130,
                                                    cursor: isWeightUnit(l.unidad) && isScaleConnected ? 'pointer' : 'text',
