...
interface PasoSeleccionPedidosProps {
    ...
    onSelectAll: () => void;
    onDeselectAll: () => void;
    onSelectProvider: (e: any) => void;
    onDeselectProvider: (e: any) => void;
        ...
        <Box>
            ...
            {loadingPedidos ? <CircularProgress /> : (
                <>
                    ...
                    <List sx={{ width: '100%', bgcolor: 'background.paper', maxHeight: '55vh', overflow: 'auto', border: 1, borderColor: 'divider', borderRadius: 1 }}>
                        {pedidosDisponibles.map((pedido) => (
                            ...
                            >
                                ...
                                >
                                    <Checkbox checked={pedidosSeleccionadosIds.includes(pedido.id)} />
                                    <ListItemText
