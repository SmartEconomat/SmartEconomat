...
export default function SettingsMenu({ mode = 'icon', isOpen = true }: SettingsMenuProps) {
    const [anchorEl, setAnchorEl] = useState<null | HTMLElement>(null);
    const { currentThemeName, setTheme, fontSize, setFontSize, isLearningMode } = useThemeContext();
    ...
    if (mode === 'listitem') {
        return (
            <>
                <Tooltip title={getTooltipContent(isOpen, isLearningMode, "Configuración", "Configuración de tema y apariencia")}>
                    <ListItemButton
                        onClick={handleClick}
                    ...
                    >
                        ...
                        <ListItemText primary="Configuración" sx={{ opacity: isOpen ? 1 : 0 }} />
                    </ListItemButton>
                </Tooltip>
                <Menu
                    anchorEl={anchorEl}
    ...
    return (
        <>
            <Tooltip title={getTooltipContent(false, isLearningMode, "Ajustes", "Configuración")} placement="bottom">
                <IconButton
                    onClick={handleClick}
                    size="small"
                    sx={{ ml: 2, color: 'white' }}
