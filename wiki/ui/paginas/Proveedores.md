...
- **[DetailModal](../componentes/DetailModal.md)**: Muestra la ficha completa del proveedor al pulsar el icono de visualización (ojo).
...
| :--- | :--- | :--- | :--- |
| Nombre | `nombre` | Texto | Razón social del proveedor. |
| NIF | `nif` | Texto | Identificación fiscal. |
| Contacto | `contacto` | Texto | Persona de enlace (oculto en móvil). |
| Teléfono | `telefono` | Texto | Teléfono de contacto (oculto en móvil). |
| Email | `email` | Texto | Correo electrónico principal (oculto en móvil). |
