...
- **UUID v7**: Ver `UUID_V7_ARCHITECTURE.md` para detalles sobre la gestión de identificadores
- **API REST**: Ver `wiki/API.md` para documentación completa de endpoints
