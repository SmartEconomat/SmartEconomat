...
export class CreateUsuarioDto {
  @Transform(TrimStringTransformer.transform)
  @IsString({ message: i18nValidationMessage('validation.EL_NOMBRE_DEBE_SER_UNA_CADENA') })
  @IsNotEmpty()
  @MaxLength(100)
  nombre: string;
...
Ver [normalizacion-datos.md](./normalizacion-datos.md) para la guía completa.
